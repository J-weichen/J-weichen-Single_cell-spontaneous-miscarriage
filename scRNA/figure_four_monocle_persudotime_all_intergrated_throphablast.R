...
saveRDS(seurat_data_list, file = "/mnt/data/chenwei/gongchen/6.monocle2/All_Trophoblast_seurat_sample_list.rds")
...
#saveRDS(anchors, file = "/mnt/data/chenwei/gongchen/6.monocle2/Trophoblast_sample_list.anchor.rds")
#seurat_data_list<-anchors<-dtlist<-intfts<-0
########################
### Integrate
########################
#anchors<-readRDS(file = "/mnt/data/chenwei/gongchen/6.monocle2/Trophoblast_sample_list.anchor.rds")
...
saveRDS(selected_cell, file = "/mnt/data/chenwei/gongchen/6.monocle2/All_Trophoblast_seurat_pbject.rds")
...
cell_distribution2<-ggplot(meta_plot2,aes(x = Pseudotime,y = final_major_subgroup_brief_Treat, colour = Treat)) +
  geom_quasirandom(groupOnX = FALSE) +
...
ggplot(meta_plot2,aes(x=Pseudotime,fill=Treat,alpha = 1/10))+geom_density()+scale_fill_manual(values = ppCor[c(3,5)]) + theme_classic()+facet_wrap(~final_major_subgroup_brief, ncol = 3)
ggplot(meta_plot2,aes(x=Pseudotime,colour=Treat))+geom_density()+scale_color_manual(values = ppCor[c(3,5)]) + theme_classic() +facet_wrap(~final_major_subgroup_brief, ncol = 3)
ggplot(meta_plot2,aes(x=Pseudotime,fill=final_major_subgroup_brief,alpha = 1/10,colour=Treat))+
...
seurat_data_list<-readRDS(file = "/mnt/data/chenwei/gongchen/6.monocle2/All_Trophoblast_seurat_sample_list.rds")
...
head(metadata_new)
selected_cell@meta.data<-metadata_new
saveRDS(selected_cell, file = "/mnt/data/chenwei/gongchen/6.monocle2/CTRL_Trophoblast_seurat_pbject.rds")
...
head(metadata_new)
selected_cell@meta.data<-metadata_new
saveRDS(selected_cell, file = "/mnt/data/chenwei/gongchen/6.monocle2/Abortion_Trophoblast_seurat_pbject.rds")
