...
#for Abortion 
data.dir <- '/mnt/data/chenwei/gongchen/7.cellchat/Abortion'
setwd(data.dir)
cellchat<-readRDS(file = "/mnt/data/chenwei/gongchen/7.cellchat/Abortion/Abortion_cellchat.rds")
...
pdf("/mnt/data/chenwei/gongchen/7.cellchat/Abortion/Abortion_cellchat_network_circle_plot.pdf",width=13,height=6)
...
pdf("/mnt/data/chenwei/gongchen/7.cellchat/Abortion/Abortion_cellchat_network_circle_plot_split.pdf",width=25,height=16)
...
for (i in 1:length(pathways.show.all)) {
  ...
  ggsave(filename=paste0(data.dir,"/Abortion_",pathways.show.all[i], "_L-R_contribution.pdf"), plot=gg, width = 8, height = length(pathyway_CPIpair[[pathways.show.all[i]]])*0.3,limitsize = FALSE)
}
...
# Circle plot
pdf("/mnt/data/chenwei/gongchen/7.cellchat/Abortion/Abortion_SEMA3_path_network_circle_plot.pdf",width=8,height=8)
par(mfrow=c(1,1))
netVisual_aggregate(cellchat, signaling = pathways.show, layout = "circle")
dev.off()

# Heatmap
pdf("/mnt/data/chenwei/gongchen/7.cellchat/Abortion/Abortion_SEMA3_path_network_Heatmap_plot.pdf",width=10,height=10)
par(mfrow=c(1,1))
netVisual_heatmap(cellchat, signaling = pathways.show, color.heatmap = "Reds")
dev.off()
# Chord diagram
pdf("/mnt/data/chenwei/gongchen/7.cellchat/Abortion/Abortion_SEMA3_path_network_Chord_plot.pdf",width=8,height=8)
par(mfrow=c(1,1))
...
levels(cellchat@meta$re_annotation_TFac)
vertex.receiver = c(10,11,12,13) # a numeric vector. 
pdf("/mnt/data/chenwei/gongchen/7.cellchat/Abortion/Abortion_SEMA3_path_network_hierarchy_plot.pdf",width=12,height=6)
netVisual_aggregate(cellchat, signaling = pathways.show,  vertex.receiver = vertex.receiver,layout = "hierarchy")
dev.off()

#Compute the contribution of each ligand-receptor pair to the overall signaling pathway and visualize cell-cell communication mediated by a single ligand-receptor pair
pdf("/mnt/data/chenwei/gongchen/7.cellchat/Abortion/Abortion_SEMA3_path_contribution_of_each_ligand-receptor_pair_plot.pdf",width=6,height=6)
...
# Circle plot
pdf(paste0("/mnt/data/chenwei/gongchen/7.cellchat/Abortion/Abortion_SEMA3_path_individualpair_",LR.show,"_circle_plot.pdf"),width=8,height=8)
netVisual_individual(cellchat, signaling = pathways.show,pairLR.use = LR.show,  layout = "circle")
dev.off()

# Chord diagram
pdf(paste0("/mnt/data/chenwei/gongchen/7.cellchat/Abortion/Abortion_SEMA3_path_individualpair_",LR.show,"_Chord_plot.pdf"),width=8,height=8)
...
levels(cellchat@meta$re_annotation_TFac)
vertex.receiver = c(10,11,12,13) # a numeric vector. 
pdf(paste0("/mnt/data/chenwei/gongchen/7.cellchat/Abortion/Abortion_SEMA3_path_individualpair_",LR.show,"_hierarchy_plot.pdf"),width=12,height=6)
...
pdf(paste0("/mnt/data/chenwei/gongchen/7.cellchat/Abortion/Abortion_outcomming_EVT2_EVT3_interaction_pair_dot_plot.pdf"),width=10,height=30)
netVisual_bubble(cellchat, sources.use = c(7,8), targets.use = c(1:6,8:15), remove.isolate = TRUE)
dev.off()
pdf(paste0("/mnt/data/chenwei/gongchen/7.cellchat/Abortion/Abortion_intcomming_EVT2_EVT3_interaction_pair_dot_plot.pdf"),width=10,height=30)
...
pdf("/mnt/data/chenwei/gongchen/7.cellchat/Abortion/Abortion_netP_EVT2_EVT3_interaction_pair_circle_plot.pdf",width=25,height=25)
...
pdf("/mnt/data/chenwei/gongchen/7.cellchat/Abortion/Abortion_sender_receiver_mediator_influencer_for_each_pathway_circle_plot.pdf",width=5,height=10)
...
for (i in 1:length(pathways.show.all)) {
  ...
  ggsave(filename=paste0(data.dir,"/pathway_gene/Abortion_",pathways.show.all[i], "_gene_expression_violin_plot.pdf"), plot=violin_plot, width = 10, height = length(pathyway_CPIpair[[pathways.show.all[i]]])*0.3,limitsize = FALSE)
}
...
pdf("/mnt/data/chenwei/gongchen/7.cellchat/Abortion/Abortion_out_income_all_signaling_pathways_2D_plot.pdf",width=8,height=8)
...
pdf("/mnt/data/chenwei/gongchen/7.cellchat/Abortion/Abortion_heatmap_out_income_all_signaling_pathways_plot.pdf",width=21,height=25)
ht1 + ht2
dev.off()
...
pdf("/mnt/data/chenwei/gongchen/7.cellchat/Abortion/Abortion_lineplot_for_pattern_number.pdf",width=5,height=5)
...
nPatterns = 3
grid.newpage()
pdf("/mnt/data/chenwei/gongchen/7.cellchat/Abortion/Abortion_3_outgoing_pattern_identification.pdf",width=15,height=25)
cellchat <- identifyCommunicationPatterns(cellchat, pattern = "outgoing", k = nPatterns, width = 15,height =25)
dev.off()
# river plot
pdf("/mnt/data/chenwei/gongchen/7.cellchat/Abortion/Abortion_alluvial_plot_3_outgoing_pattern.pdf",width=21,height=20)
netAnalysis_river(cellchat, pattern = "outgoing")
dev.off()
# dot plot
pdf("/mnt/data/chenwei/gongchen/7.cellchat/Abortion/Abortion_dot_plot_3_outgoing_pattern.pdf",width=20,height=12)
...
nPatterns = 3
grid.newpage()
pdf("/mnt/data/chenwei/gongchen/7.cellchat/Abortion/Abortion_3_incoming_pattern_identification.pdf",width=17,height=25)
cellchat <- identifyCommunicationPatterns(cellchat, pattern = "incoming", k = nPatterns, width = 17,height =25)
dev.off()
# river plot
pdf("/mnt/data/chenwei/gongchen/7.cellchat/Abortion/Abortion_alluvial_plot_3_incoming_pattern.pdf",width=21,height=20)
netAnalysis_river(cellchat, pattern = "incoming")
dev.off()
# dot plot
pdf("/mnt/data/chenwei/gongchen/7.cellchat/Abortion/Abortion_dot_plot_3_incoming_pattern.pdf",width=20,height=12)
netAnalysis_dot(cellchat, pattern = "incoming")
dev.off()

# Visualization  functional similarity  in 2D-space
pdf("/mnt/data/chenwei/gongchen/7.cellchat/Abortion/Abortion_Dim_plot_3_functional_similarity.pdf",width=20,height=20)
netVisual_embedding(cellchat, type = "functional", label.size = 3.5)
netVisual_embeddingZoomIn(cellchat, type = "functional", nCol = 2)
dev.off()

# Visualization  structure similarity in 2D-space
pdf("/mnt/data/chenwei/gongchen/7.cellchat/Abortion/Abortion_Dim_plot_4_structural_similarity.pdf",width=20,height=20)
