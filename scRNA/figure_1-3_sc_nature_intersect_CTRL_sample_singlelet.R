...
seurat_data_list0<-seurat_data_list[1:5]
seurat_data_list2<-c(single_cell_placent_all,seurat_data_list0)
...
saveRDS(integrated, file = "/mnt/data/chenwei/gongchen/3.seurat_result/sc_nature_individual_singlelet_CTRL_sample_integrated_seurat.rds")

integrated <- readRDS(file = "/mnt/data/chenwei/gongchen/3.seurat_result/sc_nature_individual_singlelet_CTRL_sample_integrated_seurat.rds")
...
plot_annotation1<-DimPlot(object = integrated, group.by ="annotation",split.by ="data_source",label = TRUE) + NoLegend() 
plot_annotation2<-DimPlot(object = integrated, group.by ="annotation",label = TRUE) + NoLegend() 
ggsave("/mnt/data/chenwei/gongchen/3.seurat_result/individual_CTRL_sample_sc_nature_intergrate_Group_umap_annotation_split.pdf",plot_annotation1,width=12, height=6)
ggsave("/mnt/data/chenwei/gongchen/3.seurat_result/individual_CTRL_sample_sc_nature_intergrate_Group_umap_annotation_split.png",plot_annotation1,width=12, height=6)
ggsave("/mnt/data/chenwei/gongchen/3.seurat_result/individual_CTRL_sample_sc_nature_intergrate_Group_umap_annotation_merge.pdf",plot_annotation2,width=6, height=6)
ggsave("/mnt/data/chenwei/gongchen/3.seurat_result/individual_CTRL_sample_sc_nature_intergrate_Group_umap_annotation_merge.png",plot_annotation2,width=6, height=6)
...
#   1     2     3     4     5     6    
#64734 11046  6524  4544  4354  3872  
colnames(sample_info2)
sample_info_new<-sample_info2[,-c(15:37)]
tail(sample_info_new)
coldata<-data.frame(sample=c("Nature_ref","N1","N2","N3","N4","N5"),
                    sample_code=c("Nature_ref","CTRL_1","CTRL_2","CTRL_3","CTRL_4","CTRL_5"),
                    Treat=c("Nature_ref",rep("CTRL",5)),
                    Treat2=c("Nature_ref",rep("GC_data",5)),
                    gemgroup=c(1:6))
...
str(meta_data_new);tail(meta_data_new);dim(meta_data_new)##95074    23
...
integrated$Treat<-factor(integrated$Treat,levels = c("Nature_ref","CTRL"))
integrated$sample<-factor(integrated$sample,levels = c("N1","N2","N3","N4","N5","Nature_ref"))
integrated$sample_code<-factor(integrated$sample_code,levels = c("CTRL_1","CTRL_2","CTRL_3","CTRL_4","CTRL_5","Nature_ref"))
table(integrated$Treat)
#Nature_ref   CTRL 
#  64734      30340 
DimPlot(object = integrated, group.by ="annotation",split.by = "Treat") + NoLegend() 

P0<-DimPlot(object = integrated, group.by ="annotation",split.by = "Treat") + NoLegend() 
...
ggsave(paste0("/mnt/data/chenwei/gongchen/3.seurat_result/individual_CTRL_sample_sc_nature_intergrate_Group_umap_annotation2.pdf"),P1,width=12, height=6)
ggsave(paste0("/mnt/data/chenwei/gongchen/3.seurat_result/individual_CTRL_sample_sc_nature_intergrate_Group_umap_Treat1.pdf"),P1,width=6, height=6)
ggsave(paste0("/mnt/data/chenwei/gongchen/3.seurat_result/individual_CTRL_sample_sc_nature_intergrate_Group_umap_Treat2.pdf"),P2,width=12, height=6)
ggsave(paste0("/mnt/data/chenwei/gongchen/3.seurat_result/individual_CTRL_sample_sc_nature_intergrate_Group_umap_sample.pdf"),P3,width=12, height=6)
ggsave(paste0("/mnt/data/chenwei/gongchen/3.seurat_result/individual_CTRL_sample_sc_nature_intergrate_Group_umap_sample_code.pdf"),P4,width=12, height=6)
...
ggsave("/mnt/data/chenwei/gongchen/3.seurat_result/individual_CTRL_sample_sc_nature_intergrate_group_split1.png",plot_group_split1,width=16, height=8)
ggsave("/mnt/data/chenwei/gongchen/3.seurat_result/individual_CTRL_sample_sc_nature_intergrate_group_split2.png",plot_group_split2,width=16, height=8)
ggsave("/mnt/data/chenwei/gongchen/3.seurat_result/individual_CTRL_sample_sc_nature_intergrate_group_split1.pdf",plot_group_split1,width=16, height=8)
ggsave("/mnt/data/chenwei/gongchen/3.seurat_result/individual_CTRL_sample_sc_nature_intergrate_group_split2.pdf",plot_group_split2,width=16, height=8)

saveRDS(integrated, file = "/mnt/data/chenwei/gongchen/3.seurat_result/annoed_sc_nature_individual_singlelet_CTRL_sample_integrated_seurat.rds")
#integrated<-readRDS(file = "/mnt/data/chenwei/gongchen/3.seurat_result/annoed_sc_nature_individual_singlelet_CTRL_sample_integrated_seurat.rds")
